#!/usr/bin/env python3
"""Run the pre-candidate twenty-process Vivado stability gate for v2."""
...
DEFAULT_SCRATCH_ROOT = Path(r"C:\VGT3S001")
RUNS = 20
GUARD_READ_PASSES = 3
...
def command(vivado: Path, result: Path, reports: Path,
    ...
    return [
        ...
        "timing_gate_v3_stability_probe", "clk", "10.0", str(result),
...
def infrastructure_tcl_error(stdout: str, stderr: str) -> bool:
    text = stdout + "\n" + stderr
    install_error = (
        "couldn't read file \"C:/Xilinx/Vivado/2023.1/scripts/rt/data/" in text
