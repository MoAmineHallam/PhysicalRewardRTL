module rf_s3__med19__g8 (
  ...
  always @(posedge clk) begin
    if (!rst_n) begin
      ...
      s[0] = x;
      s[1] = w0; s[2] = w1; s[3] = w2; s[4] = w3; s[5] = w4; s[6] = w5; s[7] = w6; s[8] = w7; s[9] = w8; s[10] = w9; s[11] = w10; s[12] = w11; s[13] = w12; s[14] = w13; s[15] = w14; s[16] = w15; s[17] = w16; s[18] = w17;
      for (i = 0; i < 19; i = i + 1)
        for (j = 0; j < 18; j = j + 1)
