module correctness_s2__iir18_v7__g2 (
  ...
  always @(posedge clk) begin
    if (!rst_n) begin y<=0; y2<=0; xd18<=0; xd17<=0; xd16<=0; xd15<=0; xd14<=0; xd13<=0; xd12<=0; xd11<=0; xd10<=0; xd9<=0; xd8<=0; xd7<=0; xd6<=0; xd5<=0; xd4<=0; xd3<=0; xd2<=0; xd1<=0; end
    else begin
      y <= acc[15:0];
      y2 <= y;
