module grpo__iir20__g3 (
  ...
  always @(posedge clk) begin
    if (!rst_n) begin y<=16'd0; y2<=16'd0; r1<=16'd0; r2<=16'd0; r3<=16'd0; r4<=16'd0; r5<=16'd0; r6<=16'd0; r7<=16'd0; r8<=16'd0; r9<=16'd0; r10<=16'd0; r11<=16'd0; r12<=16'd0; r13<=16'd0; r14<=16'd0; r15<=16'd0; r16<=16'd0; r17<=16'd0; r18<=16'd0; r19<=16'd0; r20<=16'd0; end
    else begin
      y <= acc[15:0];
      y2 <= y;
      r1 <= (5*x + r2) & 16'hFFFF;
