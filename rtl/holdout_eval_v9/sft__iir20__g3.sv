module sft__iir20__g3 (
  ...
  reg [7:0] xd20;
  reg [15:0] y2;
  wire [31:0] accu = 3*x + 5*xd1 + 7*xd2 + 9*xd3 + 11*xd4 + 13*xd5 + 15*xd6 + 17*xd7 + 19*xd8 + 21*xd9 + 23*xd10 + 25*xd11 + 27*xd12 + 29*xd13 + 31*xd14 + 33*xd15 + 35*xd16 + 37*xd17 + 39*xd18 + 41*xd19 + 43*xd20 + ((9*y)>>4) + ((5*y2)>>4);
