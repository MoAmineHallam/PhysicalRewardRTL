// 16-iteration rotation-mode CORDIC, FULLY PIPELINED (one register per
// iteration) -> short per-stage path, higher Fmax. Same result, +16 latency.
module cordic16__v1 (
    input  wire        clk,
    input  wire        rst_n,
    input  wire [7:0]  x,
    ...
    reg signed [23:0] xr13, yr13, zr13;
    reg signed [23:0] xr14, yr14, zr14;
    reg signed [23:0] xr15, yr15, zr15;
    reg signed [23:0] xr16, yr16, zr16;
    integer k;
    always @(posedge clk) begin
        if (!rst_n) begin xr1<=0; yr1<=0; zr1<=0; xr2<=0; yr2<=0; zr2<=0; xr3<=0; yr3<=0; zr3<=0; xr4<=0; yr4<=0; zr4<=0; xr5<=0; yr5<=0; zr5<=0; xr6<=0; yr6<=0; zr6<=0; xr7<=0; yr7<=0; zr7<=0; xr8<=0; yr8<=0; zr8<=0; xr9<=0; yr9<=0; zr9<=0; xr10<=0; yr10<=0; zr10<=0; xr11<=0; yr11<=0; zr11<=0; xr12<=0; yr12<=0; zr12<=0; xr13<=0; yr13<=0; zr13<=0; xr14<=0; yr14<=0; zr14<=0; xr15<=0; yr15<=0; zr15<=0; xr16<=0; yr16<=0; zr16<=0; y <= 16'd0; end
        else begin
            ...
            xr13 <= (zr12 >= 0) ? (xr12 - (yr12 >>> 12)) : (xr12 + (yr12 >>> 12));
            yr13 <= (zr12 >= 0) ? (yr12 + (xr12 >>> 12)) : (yr12 - (xr12 >>> 12));
            zr13 <= (zr12 >= 0) ? (zr12 - 24'sd0) : (zr12 + 24'sd0);
            xr14 <= (zr13 >= 0) ? (xr13 - (yr13 >>> 13)) : (xr13 + (yr13 >>> 13));
            yr14 <= (zr13 >= 0) ? (yr13 + (xr13 >>> 13)) : (yr13 - (xr13 >>> 13));
            zr14 <= (zr13 >= 0) ? (zr13 - 24'sd0) : (zr13 + 24'sd0);
            xr15 <= (zr14 >= 0) ? (xr14 - (yr14 >>> 14)) : (xr14 + (yr14 >>> 14));
            yr15 <= (zr14 >= 0) ? (yr14 + (xr14 >>> 14)) : (yr14 - (xr14 >>> 14));
            zr15 <= (zr14 >= 0) ? (zr14 - 24'sd0) : (zr14 + 24'sd0);
            xr16 <= (zr15 >= 0) ? (xr15 - (yr15 >>> 15)) : (xr15 + (yr15 >>> 15));
            yr16 <= (zr15 >= 0) ? (yr15 + (xr15 >>> 15)) : (yr15 - (xr15 >>> 15));
            zr16 <= (zr15 >= 0) ? (zr15 - 24'sd0) : (zr15 + 24'sd0);
            y <= xr16[15:0];
        end
    end
endmodule
