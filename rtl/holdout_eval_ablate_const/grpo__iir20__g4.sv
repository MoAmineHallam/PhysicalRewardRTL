module grpo__iir20__g4 (
  ...
  always @(posedge clk) begin
    if (!rst_n) begin
      xd1 <= 8'd0; xd2 <= 8'd0; xd3 <= 8'd0; xd4 <= 8'd0; xd5 <= 8'd0; xd6 <= 8'd0; xd7 <= 8'd0; xd8 <= 8'd0; xd9 <= 8'd0; xd10 <= 8'd0; xd11 <= 8'd0; xd12 <= 8'd0; xd13 <= 8'd0; xd14 <= 8'd0; xd15 <= 8'd0; xd16 <= 8'd0; xd17 <= 8'd0; xd18 <= 8'd0; xd19 <= 8'd0; xd20 <= 8'd0; y <= 16'd0; y2 <= 16'd0;
    end else begin
