module sft__firr36__g4 (
    ...
    reg  [7:0]  xs [0:35];
    integer     i;
    reg  [23:0] acc; // accumulator: the long name means this register-to-
                      // register path is the longest -> lower Fmax.
