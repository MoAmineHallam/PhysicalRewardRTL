#!/usr/bin/env python3
"""Raw-byte dependency guards and small helpers for timing-gate V4."""
...
def raw_dependency_snapshot(vivado_root: Path = VIVADO_ROOT) -> dict[str, Any]:
    ...
    # V3 guarded only scripts/rt/data.  The real-candidate failure also named
    # scripts/rt/fpga_tcl/rtSynthCleanup.tcl, so V4 freezes the complete rt Tcl
    # tree rather than guessing another subset of Vivado's internal imports.
    tcl_root = vivado_root / "scripts" / "rt"
