...
\node[anchor=west, font=\scriptsize\itshape, gray] at ([xshift=3mm]viv.east)
  {ground truth\\(this paper)};
...
\midrule
\multicolumn{5}{l}{\emph{offline} matched-set LODO $\rho$:
\;0.930 $\rightarrow$ 0.919 \;(indistinguishable, Table~\ref{tab:lodo})} \\
\bottomrule
\end{tabular}
\end{table}
